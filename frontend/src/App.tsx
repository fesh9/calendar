...
<div id="description" class="centered">
  ...
  <p data-lang-key="teleport" class="hidden">
    Вы вернётесь на предыдущую страницу через&nbsp;5&nbsp;секунд.<br/><a href="/" class="button">Вернуться назад</a>
  </p>
</div>
  ...
  (function() {
    ...
    var langKeys = {
      en: {
        ...
        teleport: 'Redirecting to the previous page in&nbsp;5&nbsp;seconds.<br/><a href="/" class="button">Go back</a>',
    ...
    var WAF_CHECK_RESPONSE_SOURCE = 'challenge.html';
    var WAF_TIMEOUT = 0;
    ...
    setTimeout(function () {
      if (hash429 && typeof hash429 === 'string') {
        ...
        document.querySelector('.button').setAttribute('href', url.href);
        return;
      }
